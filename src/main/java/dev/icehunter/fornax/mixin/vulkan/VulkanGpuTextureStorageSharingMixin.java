...
import dev.icehunter.fornax.pack.graph.VulkanTextureSharing;
...
/** Lets a sampled/storage image be used on both the graphics and compute queue families. */
...
abstract class VulkanGpuTextureStorageSharingMixin {
    ...
    private VkImageCreateInfo fornax$shareStorageImageAcrossQueues(VkImageCreateInfo info) {
        ...
        return VulkanTextureSharing.configure(info, ((GpuTexture) (Object) this).usage(), graphicsFamily, computeFamily);
    }
}
